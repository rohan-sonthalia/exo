...
parser.add_argument("--partitioning-strategy", type=str, choices=["ring", "hybrid"], default="ring", help="Partitioning strategy: 'ring' for RingMemoryWeightedPartitioningStrategy or 'hybrid' for HybridFLOPSMemoryPartitioningStrategy"
)
...
if args.partitioning_strategy == "ring":
    partitioning_strategy = RingMemoryWeightedPartitioningStrategy()
else:
    partitioning_strategy = HybridFLOPSMemoryPartitioningStrategy()
